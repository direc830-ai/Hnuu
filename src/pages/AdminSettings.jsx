            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-4">
                  {['light', 'dark'].map((t) => (
                    <label key={t} className="flex items-center gap-2 cursor-pointer group" onClick={() => set('theme', t)}>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-full ${cls} shadow-sm transition-all ${settings.accentColor === key ? 'ring-2 ring-offset-2 ring-blue-600 scale-110' : 'opacity-50 hover:opacity-100'}`}
                    />
                  ))}
                </div>
              </div>
